"""Overlord MCP server — exposes supervisor tools to Cursor / Claude Code."""
...
BASE = os.getenv("OVERLORD_API_BASE", "http://127.0.0.1:8000")
mcp = FastMCP("overlord")
...
@mcp.tool()
def overlord_get_history(session_id: str) -> list:
