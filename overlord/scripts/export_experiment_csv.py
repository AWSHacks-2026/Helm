...
def _row_from_comparison_report(path: Path, data: dict) -> dict[str, object]:
    ...
    row: dict[str, object] = {
        ...
        "overlord_path": o.get("path", ""),
        "baseline_tokens": c.get("baseline_tokens", b_usage.get("total_tokens", "")),
        "overlord_tokens": c.get("overlord_tokens", o_usage.get("total_tokens", "")),
        "token_savings_pct": c.get("token_savings_pct", ""),
        "baseline_cost_usd": c.get("baseline_cost_usd", b_usage.get("estimated_cost_usd", "")),
        "overlord_cost_usd": c.get("overlord_cost_usd", o_usage.get("estimated_cost_usd", "")),
        "baseline_cost_display": c.get("baseline_cost_display", b_usage.get("estimated_cost_display", "")),
        "overlord_cost_display": c.get("overlord_cost_display", o_usage.get("estimated_cost_display", "")),
        "cost_savings_pct": c.get("cost_savings_pct", ""),
        "overlord_beats_cost": c.get("overlord_beats_cost", ""),
        "baseline_resolution_time_ms": c.get(
            "baseline_resolution_time_ms", b.get("resolution_time_ms", "")
        ),
        "overlord_resolution_time_ms": c.get(
            "overlord_resolution_time_ms", o.get("resolution_time_ms", "")
        ),
        "time_savings_pct": c.get("time_savings_pct", ""),
        "overlord_beats_time": c.get("overlord_beats_time", ""),
        "baseline_mean_score": c.get("baseline_mean_score", b.get("mean_score", "")),
        "overlord_mean_score": c.get("overlord_mean_score", o.get("mean_score", "")),
        "baseline_passed_all": c.get("baseline_passed_all", b.get("passed_all", "")),
        "overlord_passed_all": c.get("overlord_passed_all", o.get("passed_all", "")),
        "overlord_beats_quality": c.get("overlord_beats_quality", ""),
        "baseline_score": c.get("baseline_score", b.get("evaluation", {}).get("score", "")),
        "overlord_score": c.get("overlord_score", o.get("evaluation", {}).get("score", "")),
        "baseline_passed": c.get("baseline_passed", b.get("evaluation", {}).get("passed", "")),
        "overlord_passed": c.get("overlord_passed", o.get("evaluation", {}).get("passed", "")),
        "overlord_beats_tokens": c.get("overlord_beats_tokens", ""),
        ...
        "overlord_arbitration_calls": c.get(
            "overlord_arbitration_calls", o.get("arbitration_calls", "")
        ),
        ...
        "overlord_full_impl_runs": c.get(
            "overlord_full_implementation_runs", o.get("full_implementation_runs", "")
        ),
        "duplicate_impls_avoided": c.get("duplicate_implementations_avoided", ""),
        "overlord_duplicate_detected": c.get("overlord_duplicate_detected", ""),
        "overlord_stops_conflict": c.get("overlord_stops_conflict", ""),
        "overlord_blocked_action": c.get("overlord_blocked_action", ""),
...
def collect_rows() -> list[dict[str, object]]:
    ...
    for path in sorted(RESULTS.glob("*.json")):
        try:
            ...
            continue
        if "comparison" in data and ("baseline" in data or "overlord" in data):
