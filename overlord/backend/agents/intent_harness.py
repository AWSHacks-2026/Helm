"""Benchmark: agents proceed with conflicting intents vs Overlord intent coordination."""
...
def run_overlord_path(scenario: dict[str, Any], ledger: UsageLedger) -> dict[str, Any]:
...
def run_intent_benchmark(scenario_name: str = DEFAULT_SCENARIO) -> dict[str, Any]:
    ...
    overlord = run_overlord_path(scenario, overlord_ledger)
    ...
    return {
        ...
        "comparison": {
            ...
            **build_cost_comparison(baseline["usage"], overlord["usage"]),
            ...
            "overlord_stops_conflict": overlord["conflict_detected_before_code"],
            "baseline_agents_proceeding": baseline["agents_proceeding"],
            "overlord_agents_proceeding": overlord["agents_proceeding"],
            "overlord_beats_cost": overlord["usage"]["estimated_cost_usd"]
