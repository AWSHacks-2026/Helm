"""Benchmark: unchecked destructive action vs Overlord guardrail preflight + resolution."""
...
def run_guardrail_benchmark(scenario_name: str = DEFAULT_SCENARIO) -> dict[str, Any]:
    ...
    overlord = run_overlord_path(scenario, session_id, overlord_ledger)
    ...
    o_cost = overlord["usage"]["estimated_cost_usd"]
    ...
    return {
        ...
        "comparison": {
            ...
            **build_cost_comparison(baseline["usage"], overlord["usage"]),
            ...
            "overlord_executed": overlord["executed"],
            "overlord_blocked_action": not overlord["preflight_allowed"],
            "blocked_rule": overlord.get("blocked_rule"),
            "overlord_beats_cost": o_cost < b_cost if b_cost else False,
            "resolution_tier": overlord.get("resolution_tier"),
            "escalated_to_sonnet": overlord.get("escalated_to_sonnet"),
        },
    }
