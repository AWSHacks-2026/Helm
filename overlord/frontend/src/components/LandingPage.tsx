  ...
  return (
    <main className="landing-page">
      <section className="hero-panel" aria-labelledby="landing-title">
        <p className="eyebrow">Overlord Control Tower</p>
        <h1 id="landing-title">Coordinate an AI agent fleet without losing the plot.</h1>
        <p>
          Watch Overlord catch merge conflicts, enforce guardrails, and deduplicate
      ...
      <section className="landing-actions" aria-label="Start control tower">
        <article className="landing-card">
          ...
          <h2>Watch Demo</h2>
          <p>
            Step through the canned incident timeline and see how Overlord redirects
            agents in real time.
          </p>
      ...
      <section className="proof-strip" aria-label="Overlord proof points">
        <div>
