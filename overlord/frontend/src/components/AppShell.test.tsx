...
describe("AppShell", () => {
  ...
  it("wires nav buttons to view changes", () => {
    ...
    (buttonsByLabel.get("Overlord")?.props as ButtonProps).onClick?.();
    ...
    expect(onViewChange).toHaveBeenNthCalledWith(4, "proof" satisfies AppView);
    expect(onViewChange).toHaveBeenNthCalledWith(5, "labs" satisfies AppView);
