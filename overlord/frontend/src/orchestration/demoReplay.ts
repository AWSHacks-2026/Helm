...
export const createDemoReplayEvents = (): TimelineEvent[] => {
  ...
  return [
    ...
    },
    {
      ...
      description: "Billing export changes were registered with Overlord.",
      agentId: "agent-04",
    ...
    },
    {
      ...
      title: "Overlord detected duplicate auth work",
    ...
    },
    {
      ...
      title: "Overlord blocked cache guardrail violation",
    ...
    },
    {
      ...
      kind: "merge_resolved",
      title: "Overlord resolved catalog merge overlap",
    ...
    },
    {
      ...
      description: "Overlord replay reduced duplicate coordination tokens.",
      benchmark: {
