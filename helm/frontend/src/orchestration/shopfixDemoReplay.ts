  ...
  return [
    {
      ...
      agent: agent("agent_a", formatAgentName("agent_a"), "Harden session TTL", authPath),
    },
    {
      id: "sf-002",
      ...
      agent: agent("agent_b", formatAgentName("agent_b"), "OAuth callback validation", authPath),
    },
    {
      id: "sf-003",
      timestamp: "2026-05-17T16:00:24.000Z",
      kind: "agent_started",
      title: `${formatAgentName("agent_c")} started on cart.py`,
      description: "Disjoint file. No contention.",
      agent: agent("agent_c", formatAgentName("agent_c"), "Cart merge rules", cartPath),
    },
    {
      id: "sf-004",
      timestamp: "2026-05-17T16:00:36.000Z",
      kind: "agent_started",
      title: `${formatAgentName("agent_d")} started on catalog.py`,
      description: "Disjoint catalog facets work.",
      agent: agent("agent_d", formatAgentName("agent_d"), "Catalog facets", catalogPath),
    },
    {
      id: "sf-005",
      timestamp: "2026-05-17T16:00:48.000Z",
      kind: "agent_started",
      title: `${formatAgentName("agent_e")} started on orders.py`,
      description: "Disjoint orders export path.",
      agent: agent("agent_e", formatAgentName("agent_e"), "Order export hooks", ordersPath),
    },
    {
      id: "sf-006",
      timestamp: "2026-05-17T16:01:00.000Z",
      kind: "agent_started",
      title: `${formatAgentName("agent_f")} started on payments.py`,
      description: "Disjoint payments reconciliation.",
      agent: agent("agent_f", formatAgentName("agent_f"), "Payment reconciliation", paymentsPath),
    },
    {
      id: "sf-007",
