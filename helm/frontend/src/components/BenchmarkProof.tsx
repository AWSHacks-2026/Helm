  ...
  return (
    <main className="benchmark-proof">
      <header className="screen-header">
        <div>
          <p className="eyebrow">With Helm vs without Helm</p>
      ...
      <section className="proof-grid" aria-label="Benchmark summaries">
        {liveResult && (
          <article className="proof-card">
            ...
            <dl className="summary-list">
              ...
              <div>
                <dt>Helm tokens</dt>
                <dd>{liveResult.comparison.helm_tokens}</dd>
              </div>
              <div>
                <dt>Savings</dt>
        ...
        {compareResult && (
          <article className="proof-card">
            ...
            <p>
              Helm score {compareResult.summary.helm_score}% vs best naive
        ...
        <article className="proof-card static-commerce-card">
          ...
          <p>
            ...
            <code>helm/demo/generated/static-commerce-rich/</code>.
          </p>
