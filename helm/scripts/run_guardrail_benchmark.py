#!/usr/bin/env python3
"""Compare unchecked destructive action vs Helm guardrail preflight."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Helm guardrail benchmark")
    ...
    if args.fleet:
        ...
        print(
            ...
            f"{c['helm_resolution_time_ms']} ms ({c.get('resolution_tier')}) | "
            f"blocked={c.get('helm_blocked_action')}"
        )
