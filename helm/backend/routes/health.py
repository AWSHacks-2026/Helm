...
def _aws_config() -> dict:
    use_local_memory = os.getenv("HELM_USE_LOCAL_MEMORY", "true").lower() == "true"
    use_local_policy = os.getenv("HELM_USE_LOCAL_POLICY", "true").lower() == "true"
    return {
        "region": os.getenv("AWS_REGION", "us-east-1"),
        "bedrock_mock": os.getenv("HELM_MOCK_BEDROCK", "0") == "1",
