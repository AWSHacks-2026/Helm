...
def render_markdown(result: dict[str, Any]) -> str:
    ...
    lines.extend(
        ...
        "## Summary",
        "",
        "| Metric | Baseline (no Helm) | With Helm | Savings |",
        "|--------|------------------------|---------------|---------|",
        ...
        f"| Primary implementation runs | {c['baseline_full_implementation_runs']} | {c['helm_full_implementation_runs']} | {c['duplicate_implementations_avoided']} avoided |",
        "",
        f"**Duplicate detected by Helm:** {c['helm_duplicate_detected']}",
        "",
