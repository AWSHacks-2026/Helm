"""Compare baseline duplicate agent work vs Helm task deduplication."""
...
def run_baseline_path(
    ...
    """Every agent fully implements its assigned task (no Helm)."""
...
def run_dedup_benchmark(
    ...
    helm = run_helm_path(scenario, file_paths, helm_ledger, scenario_name)
    ...
    duplicate_runs_saved = (
        baseline["full_implementation_runs"] - helm["full_implementation_runs"]
    )
    ...
    return {
        ...
        "comparison": {
            ...
            **build_cost_comparison(baseline["usage"], helm["usage"]),
            ...
            "helm_full_implementation_runs": helm["full_implementation_runs"],
            "duplicate_implementations_avoided": duplicate_runs_saved,
            "helm_duplicate_detected": helm.get("duplicate_detected"),
        },
    }
