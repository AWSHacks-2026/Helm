...
def render_markdown(result: dict[str, Any]) -> str:
    ...
    return "\n".join(
        [
            "# Helm intent conflict benchmark",
            "",
            ...
            "## Summary",
            "",
            "| Metric | Baseline (both agents implement) | With Helm | Savings |",
            "|--------|----------------------------------|---------------|---------|",
            ...
            "",
            f"**Conflict detected before code:** {c.get('helm_stops_conflict', o.get('conflict_detected_before_code'))}",
